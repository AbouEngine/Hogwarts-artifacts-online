...
public class ExceptionHandlerAdvice {
    ...
    Result handleAuthenticationException(Exception e) {
        return new Result(false, StatusCode.UNAUTHORIZED, "username or password is not correct", e.getMessage());
    }

    @ExceptionHandler(AccountStatusException.class)
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    Result handleAcccountStatusException(AccountStatusException e) {
        return new Result(false, StatusCode.UNAUTHORIZED, "user account is disabled or locked", e.getMessage());
    }
